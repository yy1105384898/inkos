...
import { YYNEWAPI } from "./endpoints/yynewapi.js";
import { YYSUBAPI } from "./endpoints/yysubapi.js";
// B6 CodingPlan
...
const ALL_PROVIDERS: readonly InkosEndpoint[] = [
  ...
  ZEROONE, AI360,
  OLLAMA, OPENROUTER, CUSTOM, MISTRAL, XAI, GITHUB_COPILOT, YYNEWAPI, YYSUBAPI,
  // B6 CodingPlan（8 个）
