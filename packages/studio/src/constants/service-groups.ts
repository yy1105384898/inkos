...
export const GROUP_LABELS: Record<EndpointGroup, { zh: string; en: string }> = {
...
export const GROUP_DESCRIPTIONS: Partial<Record<EndpointGroup, { zh: string; en: string }>> = {
  aggregator: {
...
export const GROUP_SHORT_LABELS: Record<EndpointGroup, { zh: string; en: string }> = {
